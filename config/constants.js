...
const LEFT_WIDTH_PERCENTAGE = 75; // Set it to 50 if you want symmetric left and right sides' widths
const RIGHT_WIDTH_PERCENTAGE = 75; // Set it to 50 if you want symmetric left and right sides' widths
